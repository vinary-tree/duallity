...
| Component | Version |
|-----------|---------|
| `@vinary-tree/duallity` | `4.0.0-rc.3` |
| `@vinary-tree/interop` (dependency) | `4.0.0-rc.3` |
| `@vinary-tree/vinary-tree` (runtime) | `4.0.0-rc.3` |
| Node | `>= 22.14` |
| duallity C ABI | version `1`, revision `1` |

> **Release policy.** Evaluate the candidate through the exact
> `4.0.0-rc.3` version or npm's `next` tag. The package and both shared
