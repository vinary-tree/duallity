...
- MSM Metric *(external design — not part of this repo)* - The underlying MSM distance computation
- [Time Series WFST](architecture.md) - WFST representation of time series metrics
- MSM-WFST Integration *(external design — not part of this repo)* - Using MSM with WFST pipelines
