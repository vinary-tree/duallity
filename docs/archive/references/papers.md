...
>
> This bibliography was **inherited from an earlier project** (`liblevenshtein-rust`) and
> targets a forward-looking **FST + CFG + Neural** text-normalization architecture that is
> **not** part of the `duallity` crate. Most entries are out of scope. The citations that are
> genuinely relevant to duallity (Schulz & Mihov 2002; Mohri 1997; Mohri, Pereira & Riley 2002)
> have been promoted into the canonical [`references/bibliography.md`](../../references/bibliography.md).
>
> 👉 For accurate, current documentation, start at the [documentation hub](../../README.md).
...
**Key observation**: GEC remains a strong setting for symbolic and neural hybrid models, rather than
pure sequence-to-sequence modeling alone.
