...
|-----------|----------------|
| crate `duallity` | `4.0.0-rc.3` (edition 2021, **MSRV 1.95**) |
| `vinary-tree-interop` | `4.0.0-rc.3` (ABI version `1`) |
| npm `@vinary-tree/duallity` | `4.0.0-rc.3` |
| npm `@vinary-tree/interop` (dependency) | `4.0.0-rc.3` |
| npm `@vinary-tree/vinary-tree` (runtime) | `4.0.0-rc.3` |
| Node engine | `>= 22.14` |

The crate and npm facade resolve exact `4.0.0-rc.3` family dependencies. Use
