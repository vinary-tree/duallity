...
Each guide is self-contained and grounds every code example in the crate's real 4.0.0-rc.3 surface
...
- **Exact per-variant API** — [design/](../design/) documents each variant's 4.0.0-rc.3 signatures,
