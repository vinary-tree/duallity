        ...
        lattice.paths()
            .map(|path| {
                ...
                ScoredCandidate {
                    ...
                    phonetic_cost: path.total_phonetic_distance(),
                    total_cost: total,
                    path: path.edges,
                }
            })
...
- MORK Integration Overview *(external design — not part of this repo)*
- FuzzySource Implementation *(external design — not part of this repo)* (Phase A)
- Lattice Integration *(external design — not part of this repo)* (Phase B)
- WFST Composition *(external design — not part of this repo)* (Phase C)
- Grammar Correction *(external design — not part of this repo)* (Phase D)
- Structural Repair *(external design — not part of this repo)* (Future)
- PathMap Infrastructure *(external design — not part of this repo)*
...
- Dialogue Context Layer *(external design — not part of this repo)* - Coreference resolution and topic tracking
- LLM Integration Layer *(external design — not part of this repo)* - Detailed preprocessing/postprocessing
- Agent Learning Layer *(external design — not part of this repo)* - Feedback integration and personalization
- Full Architecture Overview *(external design — not part of this repo)* - Complete 6-layer design
...
| Grammar correction | Outside Sparrowhawk scope | ✅ CFG |
