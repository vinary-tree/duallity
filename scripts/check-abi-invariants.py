#!/usr/bin/env python3
"""Validate the duallity ABI invariant registry (proofs/doc/abi-invariants.tsv).

The registry is the traceability spine of the duallity ABI verification
...
duallity invariants (the weight-domain semirings, the status algebra) are
