...
# doc-math-prescan.raku — fence-aware MathJax-conformance scanner for the duallity docs.
# Ported verbatim from liblevenshtein-rust/scripts/doc-math-prescan.raku (Campaign 2);
# the mechanism is shared across the vinary-tree family so every repo lints identically.
#
