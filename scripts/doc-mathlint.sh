#!/usr/bin/env bash
#
# doc-mathlint.sh — MathJax-conformance gate for the duallity LIVING documentation.
# Ported from liblevenshtein-rust/scripts/doc-mathlint.sh; the mechanism is shared
# across the vinary-tree family so every repo lints identically.
#
...
#     3. docs/.mathlint-include.txt   (the campaign's curated living-doc manifest)
#
# Usage:
